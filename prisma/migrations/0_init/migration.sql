...
-- CreateIndex
CREATE INDEX "Reserve_list_id_start_idx" ON "Reserve"("list_id", "start");

-- CreateIndex
CREATE INDEX "Reserve_user_id_start_idx" ON "Reserve"("user_id", "start");
